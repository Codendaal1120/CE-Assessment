...
public sealed class MerchantStockLocationUpdateRequest : __ICanIterate
{
    public MerchantStockLocationUpdateRequest() { }

    [System.Diagnostics.CodeAnalysis.SetsRequiredMembers]
    [System.Text.Json.Serialization.JsonConstructor]
    public MerchantStockLocationUpdateRequest(int stock)
    {
        Stock = stock;
    }
    ...
    System.Collections.Generic.IEnumerable<(string name, object? value)> __ICanIterate.IterateProperties()
    {
        ...
        yield return ("StockLocationId", StockLocationId);
    }
}
